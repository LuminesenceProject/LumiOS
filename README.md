...
Lumi OS can be run locally, so click on this [link](https://raw.githubusercontent.com/LuminesenceProject/LumiOS/main/LumiOS.v7.html) in order to download the file. It can also be downloaded as an about:blank page.
